...
let Floret;
{
    ...
    Floret = class Floret extends Koa {
        ...
        async initChannels() {
            ...
            if (gatewayChannels) {
                ...
                for (let key in gatewayChannels) {
                    ...
                    let newChannel = new this[channelClass](config);
        ...
        async detachSubscriber(channel, subscriberName) {
            // remove a single subscriber of a channel
            
        }

        async detachSubscribers(channel) {

            // remove all subscribers of a channels
        }
        /**
         *
         */
