    ...
    Floret = class Floret extends Koa {
        ...
        async init() {
            ...
            try {
                ...
                let api = await this[gateway].register(this[name], this[uri], hostURL + '/' + this[name] + '/heartbeat', methods);
        ...
        async subscriberEventsIn() {
            ...
            try {
                subscriberApi = await this[gateway].addAPI(this[name] + '_subscribers', this[uri] + '/subscribers', hostURL + '/' + this[name] + '/subscribers', 'GET,POST,OPTIONS');
