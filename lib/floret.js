...

{
    ...
    Floret = class Floret extends Koa {
        ...
        configure(config, ...[ConfigOverride, GatewayOverride, ChannelOverride, SubscriberOverride, SubscriptionOverride, ServiceOverride, PackageOverride]) {
            ...
            this[_config] = config;
            this[_host] = config.serviceHost;
            this[_name] = config.serviceName;
            this[_port] = config.servicePort;
            this[_uri] = config.serviceURI || '/' + this[_name];
            this[_docPaths] = config.documentationPaths || [];
            ...
            this[_gateway] = new this[_gatewayClass]('gw', config.gatewayHost, config.gatewayAdminPort, config.gatewayProxyPort);
        ...
        async apiRequest(uri, method, payload, gatewayOverride) {
            ...
            console.log('sending api requrest: ' + gw.proxyURL + uri)
...
*/
        ...
        async createChannelAPI(channel) {
            ...
            console.log('creating channel api ' + channel.apiName )
