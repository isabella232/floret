...
const Sub = require('floret-subscription');
const Pub = require('floret-publication');
const Gateway = require('floret-gateway');
const Gatekeeper = require('floret-gatekeeper');
...
let Floret;
{
    ...
    Floret = class Floret extends Koa {
        ...
        constructor(serviceName, gatewayHost, ...options) {
            ...
            this[gateway] = Gateway.bind(null, gatewayHost);
