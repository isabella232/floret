...

{
  ...
  const _apiDoc = Symbol('apiDoc');
    ...
    configure(floretConfig, ...[ConfigOverride, ChannelOverride, SubscriberOverride,
      ...
      console.log('configuring floret with ', JSON.stringify(this[_config]));
      ...
      console.log('core values: this[_host], this[_name], this[_port], this[_root], this[_uri]', this[_host], this[_name], this[_port], this[_root], this[_uri])
    ...
    /**
         *
         * @returns {string} service instance
         */
    get service() {
      ...
      /**
       *
       * @returns {*} Service - class used by Floret
       * @constructor
       */
    get Service() {
    ...
    /**
         *
         * @returns {string} http router instance used by floret
         */
    get router() {
      ...
      /**
       *
       * @returns {string} gateway instance
       */
    get gateway() {
    ...
    /**
     *
     * @param {Class} pkg - Set the Package Class used by Floret
     */
    set Package(pkg) {
    ...
    /**
     *
     * @returns {*} config obj used to build the floret instance
     */
    get config() {
      return this[_config];
    }
    ...
    get baseURI() {
      ...
      /**
       *
       * @returns {Promise<Array>} resolves routes array
       */
    ...
    get registeredAPIs() {
      ...
      /**
       *
       * @param {*}<array> arr of api objects
       */
    ...
    /**
         *
         * @param {string} name - unique api name
         * @param {string} uri -  the uri registered at the gateway
         * @param {string[]} methods - allowed rest methods ex. ['GET', 'PUT', 'POST', 'DELETE', 'PATCH']
         */
    ...
    /**
         *
         * @param {string[]} newPaths - array of relative paths
         * @returns {Promise<void>}
         */
    ...
    configureSubscriptions(subs) {
      subs.map((sub) => {
        ...
        this.subscribe({
          ...
          console.log(`Unable to subscribe to ${sub.service}-${sub.channel} (${e.message})`);
        });
      });
    }
