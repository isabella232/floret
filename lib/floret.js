...
let Floret, gatewayLib, subscriberLib, publisherLib;
{
    ...
    Floret = class Floret extends Koa {
        ...
        async createChannels(){
            await this[channels].map( createChannel );
        }
        ...
        async createChannel(channel){
            ...
            // create gateway apis if not exists

            // create a new observable

            // create post route
                // call the eventHandler, passing in the ctx object and observable
        }
        ...
        async createChannel(channelName, description){
            ...
            console.log('returning ' + this[channels][channelName]);
