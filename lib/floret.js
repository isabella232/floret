...
let Floret, gatewayLib, subscriberLib, publisherLib;
{
    ...
    Floret = class Floret extends Koa {
        ...
        constructor(serviceName, serviceHost, servicePort, serviceURI, gatewayURI, gatewayAdminPort, gatewayProxyPort, ...options) {
            ...
            super();
            this[uri] = this.context.uri = serviceURI || hostURL;
            this[port] = this.context.port = servicePort || hostPort;
            ...
            this[gateway] = new Gateway('foo', gatewayURI || apiGatewayURL, gatewayAdminPort || apiGatewayAdminPort, gatewayProxyPort || apiGatewayProxyPort);
            this[subscribers] = [];
            this[channels] = [];
            this.use(koaBody);
