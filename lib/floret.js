...
let Floret;
{
    ...
    const packageClass = Symbol('packageClass');
    ...
    Floret = class Floret extends Koa {
        ...
        constructor(config, ...options) {
            ...
            this[packageClass] = options[5] || Package;
        ...
        async createSubscriberAPI() {
            ...
            this[appRouter].post('/subscribe/', async(ctx, next) => {
                ...
                .post('/unsubscribe', async (ctx) =>{
                    ...
                    console.log('state of channels ' + this[channels][channelName].name)
                    if (channelName && subscriberName && this[channels][channelName]) {
                        this[channels][channelName].unsubscribe(subscriberName);
                    }
                    // should be empty
                    ctx.body = {
                        "result": this[channels][channelName].subscribers[subscriberName]
                    }
                })
