...
let Floret;
{
    ...
    Floret = class Floret extends Koa {
        ...
        constructor(config, ...options) {
            ...
            this[_packageClass] = options[5] || Package;
        ...
        async createSubscriberAPI() {
            await this[_gateway].addAPI(this[_name] + '_subscribe', [this[_uri] + '/subscribe'], this[_host] + ':' + this[_port] + '/' + this[_name] + '/subscribe', 'GET,POST,OPTIONS').then(() => {
            ...
            await this[_gateway].addAPI(this[_name] + '_unsubscribe', [this[_uri] + '/unsubscribe'], this[_host] + ':' + this[_port] + '/' + this[_name] + '/unsubscribe', 'GET,POST,OPTIONS').then(() => {
