...

{
    ...
    Floret = class Floret extends Koa {
        ...
        async initChannels() {
            ...
            console.log('gatewayChannels  ' + JSON.stringify(gatewayChannels));
            console.log('channesl as it is ' + JSON.stringify(this[_channels]));

            this[_channels] = Object.assign(this[_channels], gatewayChannels);
            console.log('channesl after combine ' + JSON.stringify(this[_channels]));
            for (let key in this[_channels]) {
                console.log("running init channel for " + key)
        ...
        createEnvConfig(config, envVars) {
            let envStr='local', host, port, service, uri, gatewayHost, gatewayAdminPort, gatewayProxyPort, disconnected;
            ...
            return this.createConfig (Object.assign({}, config, envObj), service, host, port,  uri, gatewayHost, gatewayAdminPort, gatewayProxyPort, disconnected);
        }
